...
all: LDFLAGS= -L./cpp_modules/zlib/dist/lib -L./cpp_modules/urlcpp -L./cpp_modules/openssl/openssl/lib -L./cpp_modules/antlr4/runtime/Cpp/run/lib -lantlr4-runtime -lz -ldl -pthread -lurlcpp -lssl -lcrypto
...
build/src/parsing/HTTPLexer.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -std=c++23 -Iinclude -Isrc -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/parsing/HTTPParser.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -std=c++23 -Iinclude -Isrc -Icpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
